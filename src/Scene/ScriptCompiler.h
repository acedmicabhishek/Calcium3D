...
public:
    ...
    static bool CompileAndLoad(const std::string& cppPath, const std::string& engineRootPath) {
        ...
        Logger::AddLog("[ScriptCompiler] Loaded '%s' — behavior registered!", stem.c_str());
        return true;
    }

    
    static bool IsCompiled(const std::string& scriptName) {
